        ...
        <table className="table-fixed w-full text-left">
          ...
          <tbody>
            <tr className=" border-b border-[#DDE1E6]">
              ...
              <td>
                <div className="flex justify-center items-center h-[50px]">
                  <button
                    ...
                    className="bg-filled-color px-[20px] py-[1px] text-black rounded-lg mx-auto my-auto"
                  >
                    Atur
                  </button>
                </div>
              ...
              <td>
                <div className="flex justify-center items-center h-[50px]">
                  <button className="bg-filled-color px-[20px] py-[1px] text-black rounded-lg mx-auto my-auto">
                    Akses
                  </button>
                </div>
              </td>
