  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex gap-5 place-self-end">
        <Link
          href={`/daftar-anggota/form-anggota/anggota-lama/simpanan/${member.id}`}
        >
        ...
        <Link
          href={`/daftar-anggota/form-anggota/anggota-lama/pinjaman/${member.id}`}
        >
          <button className="bg-primary text-white w-[228px] h-[48px] rounded-md text-center">
            Tambah Pinjaman
          </button>
...
export default DetailAnggotaLama;
