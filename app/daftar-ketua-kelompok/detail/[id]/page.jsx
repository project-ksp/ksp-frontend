...
const DetailKetuaKelompok = () => {
  ...
  useEffect(() => {
    ...
    const getLeader = async () => {
      ...
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_BASE_URL}leaders/${id}`,
        {
          method: "GET",
          headers: {
  ...
  const submitData = async (e) => {
    e.preventDefault();
    if (
      leader.gender === "Pilih Jenis Kelamin" ||
      leader.religion === "Pilih Agama" ||
      leader.education === "Pilih Pendidikan Terakhir"
    ) {
    ...
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_BASE_URL}leaders/${leader.id}`,
      {
        method: "PUT",
        headers: {
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-4">
            <Link href={"/daftar-ketua-kelompok"}>
              <button
                type="button"
            ...
            <div className="flex flex-col w-full gap-2">
              ...
              <div className="flex-1">
                ...
                <input
                  ...
                  defaultValue={leader.nik}
                  disabled={!allowEdit}
                  onChange={(e) =>
                    setLeader({ ...leader, nik: e.target.value })
                  }
                  required
                  className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                />
              ...
              <div className="flex gap-3">
                {allowEdit ? (
                  <div className="w-1/2">
                    ...
                    >
                      {leader.religion.charAt(0).toUpperCase() +
                        leader.religion.slice(1)}
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                  ...
                  <div className="w-1/2">
                    <label htmlFor="agamaLeader">Agama</label>
                    <input
                      type="text"
                      id="agamaLeader"
                      name="agamaLeader"
                      placeholder="Isi Agama Leader"
                      defaultValue={leader.religion}
                      disabled={!allowEdit}
                      className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                    />
                  </div>
                ...
                {allowEdit ? (
                  ...
                  <div className="w-1/2">
                    <label htmlFor="pendidikanLeader">
                      Pendidikan Terakhir
                    </label>
                    <input
                      type="text"
                      id="pendidikanLeader"
                      name="pendidikanLeader"
                      placeholder="Isi Pendidikan Leader"
                      defaultValue={leader.education}
                      disabled={!allowEdit}
                      className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                    />
                  </div>
              ...
              <div className="flex gap-3">
                <div className="w-1/4">
                  ...
                  <input
                    ...
                    defaultValue={leader.birthPlace}
                    disabled={!allowEdit}
                    onChange={(e) =>
                      setLeader({ ...leader, birthPlace: e.target.value })
                    }
                    required
                    className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                  />
                ...
                <div className="w-1/4">
                  <label htmlFor="tanggalLahirLeader">Tanggal Lahir</label>
                  <input
                    type="date"
                    id="tanggalLahirLeader"
                    name="tanggalLahirLeader"
                    placeholder="Isi Tanggal Lahir Leader"
                    value={leader.birthDate}
                    disabled={!allowEdit}
                    onChange={(e) =>
                      new Date(e.target.value) < Date.now()
                        ? setLeader({ ...leader, birthDate: e.target.value })
                        : setLeader({ ...leader, birthDate: Date.now() })
                    }
                    required
                    className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                  />
                ...
                <div className="w-1/4">
                  ...
                  <input
                    ...
                    value={countAge(leader.birthDate).toString()}
                    required
                    disabled
                    className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                  />
                ...
                {allowEdit ? (
                  ...
                  <div className="w-1/4">
                    <label htmlFor="jenisKelaminLeader">Jenis Kelamin</label>
                    <input
                      type="text"
                      id="jenisKelaminLeader"
                      name="jenisKelaminLeader"
                      placeholder="Isi Jenis Kelamin Leader"
                      defaultValue={leader.gender}
                      disabled={!allowEdit}
                      className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                    />
                  </div>
              ...
              <div className="flex gap-3">
                <div className="w-1/2">
                  ...
                  <input
                    ...
                    disabled={!allowEdit}
                    onChange={(e) =>
                      setLeader({ ...leader, address: e.target.value })
                    }
                    required
                    className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                  />
              ...
              <div className="flex gap-3">
                <div className="w-1/3">
                  ...
                  <input
                    ...
                    defaultValue={leader.kelurahan}
                    disabled={!allowEdit}
                    onChange={(e) =>
                      setLeader({ ...leader, kelurahan: e.target.value })
                    }
                    required
                    className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                  />
                ...
                <div className="w-1/3">
                  ...
                  <input
                    ...
                    defaultValue={leader.kecamatan}
                    disabled={!allowEdit}
                    onChange={(e) =>
                      setLeader({ ...leader, kecamatan: e.target.value })
                    }
                    required
                    className="w-full py-[10px] px-[20px] border border-[#d9d9d9] rounded-md mt-[8px] bg-white focus:outline-none disabled:bg-black/5 disabled:cursor-not-allowed"
                  />
